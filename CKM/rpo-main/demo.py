...
with open('/common/home/km1558/szr/CKM/enhanced/llm-attacks-main/data/advbench/harmful_behaviors.csv', mode='r') as file:
    ...
    for row in csv_reader:
        ...
        safe_target = "Sorry, but I cannot assist with it."
        ...
        model = AutoModelForCausalLM.from_pretrained("meta-llama/Llama-2-7b-chat-hf").to("cuda:4")
        ...
        for i in range(num_steps):
            ...
            if is_success:
                with open("suffix_log.txt", "a") as f:
                    f.write(best_new_rpo_suffix + "\n")
                break
